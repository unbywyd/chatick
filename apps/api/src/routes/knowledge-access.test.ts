...
describe('поиск по умолчанию смотрит на всю компанию', () => {
  ...
  it('мост ищет по компании, если не сказано иначе', () => {
    ...
    // Срез до КОНЦА ручки, а не на 2500 символов вперёд: фиксированная длина
    // ломается от любой правки выше по файлу. Так и вышло — ручка подросла, и
    // companyWide выехал за границу среза, хотя код был цел.
