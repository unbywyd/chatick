    ...
    <div className="relative flex h-full flex-col overflow-hidden">
      ...
      <footer className="border-t p-3">
        ...
        <div data-tour="composer">
          ...
          /*
           * Плейсхолдер короткий, но клавишу называет.
           *
           * Было «Написать в группу… Ctrl+Enter — отправить» — в узкой панели
           * не помещалось и уезжало в прокрутку. Убрать подсказку целиком
           * нельзя: голый Enter переносит строку, человек жмёт его и не
           * понимает, почему сообщение не уходит. Оставили самое короткое,
           * что ещё отвечает на вопрос: «В группу… ⌘+Enter».
           */
          placeholder={
            llmMissing
 ...
 *
 * Нужна в плейсхолдере: писать «Ctrl» человеку на Маке — называть комбинацию,
 * которой у него нет.
 */
