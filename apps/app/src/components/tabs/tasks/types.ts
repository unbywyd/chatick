...
export type Task = {
  ...
  blocking?: number
  /**
   * С какого момента держит: дата самой давней живой связки, не возраст самой
   * задачи. Задачу могли завести неделю назад, а блокером она стала вчера.
   *
   * null — когда связок нет или все ждущие уже закрыты: тогда blocking ещё
   * считает историю связей, но никого она больше не держит.
   */
